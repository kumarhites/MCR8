export const fakeFetch = (url) => {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      if (url === "https://example.com/api/meetups") {
        resolve({
          status: 200,
          message: "Success",
          data: {
            meetups: [
                ...
                speakers: [
                  {
                    name: "John Smith",
                    image:
                      "https://i.postimg.cc/J7xjYLnc/pexels-photo-5384445.jpg",
                    designation: "CTO",
                  },
                  {
                    name: "Jane Doe",
                    image:
                      "https://i.postimg.cc/tC5yVBBg/pexels-photo-1130626.jpg",
              ...
              },
              {
                ...
                eventThumbnail:
                  "https://i.postimg.cc/vT1XfrxT/pexels-photo-7256897.jpg",
                eventDescription:
                ...
                speakers: [
                  {
                    name: "Emily Johnson",
                    image:
                      "https://i.postimg.cc/d3wpsYPj/pexels-photo-1181686.jpg",
                    designation: "Design Director",
                  },
                  {
                    name: "Alex Brown",
                    image:
                      "https://i.postimg.cc/zBm4QhxM/pexels-photo-1516680.jpg",
              ...
              },
              {
                ...
                eventThumbnail:
                  "https://i.postimg.cc/L8FvgZ94/pexels-photo-6476776.jpg",
                eventDescription:
                ...
                speakers: [
                  {
                    name: "Sarah Johnson",
                    image:
                      "https://i.postimg.cc/yxTqcNXG/pexels-photo-1239288.jpg",
                    designation: "Marketing Manager",
                  },
                  {
                    name: "Michael Brown",
                    image:
                      "https://i.postimg.cc/nL96T2GB/pexels-photo-2182970.jpg",
              ...
              },
              {
                ...
                address: "",
                eventThumbnail:
                  "https://i.postimg.cc/k59jzRzY/event-492280317.jpg",
                eventDescription:
                ...
                speakers: [
                  {
                    name: "David Anderson",
                    image:
                      "https://i.postimg.cc/5yW18TcX/pexels-photo-220453.jpg",
                    designation: "Startup Coach",
                  },
                  {
                    name: "Emma Roberts",
                    image:
                      "https://i.postimg.cc/vZYYPJ49/pexels-photo-3796217.jpg",
              ...
              },
              {
                ...
                eventThumbnail:
                  "https://i.postimg.cc/dVGH5jHT/600-498146586.webp",
                eventDescription:
                ...
                speakers: [
                  {
                    name: "Robert Wilson",
                    image:
                      "https://i.postimg.cc/yYBsdMX5/pexels-photo-2379004.jpg",
                    designation: "Data Scientist",
                  },
                  {
                    name: "Linda Thompson",
                    image:
                      "https://i.postimg.cc/RFhTx7Rd/pexels-photo-3756679.jpg",
              ...
              },
              {
                ...
                address: "",
                eventThumbnail:
                  "https://i.postimg.cc/HxN9Yrvg/event-511954422.jpg",
                eventDescription:
                ...
                speakers: [
                  {
                    ...
                    image:
                      "https://i.postimg.cc/Nfpq0509/pexels-photo-2379005.jpg",
                    designation: "Professional Photographer",
                  },
                  {
                    name: "Olivia Walker",
                    image:
                      "https://i.postimg.cc/PJbHyyh2/pexels-photo-774909.jpg",
              ...
              },
              {
                ...
                eventThumbnail:
                  "https://i.postimg.cc/WtLmZQPY/pexels-photo-6694543.jpg",
                eventDescription:
                ...
                speakers: [
                  {
                    name: "William Adams",
                    image:
                      "https://i.postimg.cc/7LcqZbmM/pexels-photo-5792641.jpg",
                    designation: "Financial Analyst",
                  },
                  {
                    name: "Sophia Miller",
                    image:
                      "https://i.postimg.cc/0yBTpFD9/pexels-photo-762020.jpg",
              ...
              },
              {
                ...
                address: "",
                eventThumbnail:
                  "https://i.postimg.cc/kMkLwGJz/event-495951818.jpg",
                eventDescription:
                ...
                speakers: [
                  {
                    ...
                    image:
                      "https://i.postimg.cc/XvXVW9cY/pexels-photo-5876695.jpg",
                    designation: "Fitness Instructor",
                  },
                  {
                    name: "Daniel Thompson",
                    image:
                      "https://i.postimg.cc/sxWL4gPz/pexels-photo-1681010.jpg",
              ...
              },
              {
                ...
                address: "",
                eventThumbnail:
                  "https://i.postimg.cc/nhxgbWQ1/pexels-photo-3004909.jpg",
                eventDescription:
              ...
              },
              {
                ...
                address: "",
                eventThumbnail:
                  "https://i.postimg.cc/VNLh5bgr/event-492294898.jpg",
                eventDescription:
